     ...
     */
				...
				function _deconstructPacket(data, buffers) {
					...
					if (isBuf(data)) {
						...
						return newData;
					} else if ((typeof data === 'undefined' ? 'undefined' : _typeof2(data)) === 'object' && !(data instanceof Date)) {
						var newData = {};
						for (var key in data) {
     ...
     */
				...
				exports.removeBlobs = function (data, callback) {
					function _removeBlobs(obj, curKey, containingObject) {
						...
						} else if ((typeof obj === 'undefined' ? 'undefined' : _typeof2(obj)) === 'object' && !isBuf(obj)) {
							// and object
							for (var key in obj) {
    ...
    */
     ...
     */
				...
				function hasBinary(obj) {
					if (!obj || (typeof obj === 'undefined' ? 'undefined' : _typeof2(obj)) !== 'object') {
						return false;
					}
