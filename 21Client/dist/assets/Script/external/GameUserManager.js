...
var ClientUserItem = require("ClientUserItem");
var GD = require("GD");
...
var GameUserManager = cc.Class({
    ...
    init: function init(clientKernel) {
        this.tableUserItem = [];
        this.clientKernel = clientKernel;
    },

    //删除用户
    deleteUserItem: function deleteUserItem(clientUserItem) {
    ...
    //创建玩家
    createNewUserItem: function createNewUserItem(userInfo) {
    ...
    //更新分数
    updateUserItemScore: function updateUserItemScore(clientUserItem, userScore) {
        clientUserItem.score = userScore;
        this.clientKernel.onUserItemUpdateScore(clientUserItem, userScore);
    },
    //更新状态
    updateUserItemStatus: function updateUserItemStatus(clientUserItem, statusInfo) {
...
//# sourceMappingURL=GameUserManager.js.map