...
var RuleTxt = "一、基本玩法\n1.游戏8副牌，除去大小王，牌盒中的牌。玩家的目标是使手中牌的点数之和不超过21点，" + "且尽量最大。如果超过21点，称为爆牌，立即输掉游戏。\n2.在计算牌面点数时，10、J、Q、K均算作10点，A即可当做1点" + "或11点，由玩家决定。闲家只与庄家进行点数比较。\n3.开局只有2张牌时，可执行双倍操作，即再下一注，再获得一张牌后，" + "强制停牌。\n4.如最初2张牌是一对，可执行分牌操作，即再下一注，将牌分为2份，分别操作。\n5.如果玩家最初拿到一张A" + "和一张10点牌，就拥有黑杰克（Blackjack），本轮中自己不再进行操作。（分牌后的黑杰克只算普通21点）\n6.要牌满5张且" + "总点数小于21，称为五小龙。黑杰克与五小龙都按1.5倍赔付。\n7.所有闲家一次操作完成后，由庄家进行操作，庄家点数小于" + "17点是必须要牌，大于等于17点后，必须停牌。所有牌型中，黑杰克>五小龙>普通21点>其他点数。\n" + "二、关于保险\n1.如果庄家最开始的明牌是A，则玩家可以考虑买不买保险，金额是赌筹的一半。\n" + "2.购买保险后，如果庄家是blackjack，那么玩家拿回保险金，并从庄家处获得2倍保险金；如果庄家没有blackjack则玩家" + "失去保险金。\n三、算牌技巧\n“高低法（High-Low）”的算牌法。在游戏过程中，我们把每一张出现的" + "2，3，4，5，6都算+1点，7，8，9算0点，10，J，Q，K，A算－1点。$n比如前面出现的牌是：" + "4，9，10，5，J，A，8，10，Q，2，6，K，J，7那么点数就是4张小牌减7张大牌，是－3，点数越大，庄家越容易爆牌。";
