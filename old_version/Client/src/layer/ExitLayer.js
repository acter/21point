...
var ExitLayer = cc.Layer.extend({
    ...
    initEx: function () {
        this.showPanelBtn = new FocusButton("res/21dian/exit/show_n.png", "", "", ccui.Widget.PLIST_TEXTURE).to(this).anchor(0, 1).pp(0, 1);
        this.hidePanelBtn = new FocusButton("res/21dian/exit/hide_n.png", "", "", ccui.Widget.PLIST_TEXTURE).to(this).anchor(0, 1).pp(0, 1).hide();
        ...
        this.panel = new cc.Sprite("#res/21dian/exit/panel.png").anchor(0, 1).hide();

        this.hallBtn = new FocusButton("res/21dian/exit/hallBtn.png", "res/21dian/exit/hallBtn.png", "", ccui.Widget.PLIST_TEXTURE).to(this.panel).pp(0.5, 0.82);
        this.hallBtn.setPressedActionEnabled(true);
        this.hallBtn.addClickEventListener(this.onClickBtn.bind(this));

        this.effectBtn = new FocusButton("res/21dian/exit/effect_e.png", "res/21dian/exit/effect_e.png", "", ccui.Widget.PLIST_TEXTURE).to(this.panel).pp(0.5, 0.52);
        this.effectBtn.setPressedActionEnabled(true);
        this.effectBtn.addClickEventListener(this.onClickBtn.bind(this));

        this.musicBtn = new FocusButton("res/21dian/exit/music_e.png", "res/21dian/exit/music_e.png", "", ccui.Widget.PLIST_TEXTURE).to(this.panel).pp(0.5, 0.22);
        this.musicBtn.setPressedActionEnabled(true);
        this.musicBtn.addClickEventListener(this.onClickBtn.bind(this));

        this.effectOffBtn = new FocusButton("res/21dian/exit/effect_d.png", "res/21dian/exit/effect_d.png", "", ccui.Widget.PLIST_TEXTURE).to(this.panel).pp(0.5, 0.52).hide();
        this.effectOffBtn.setPressedActionEnabled(true);
        this.effectOffBtn.addClickEventListener(this.onClickBtn.bind(this));

        this.musicOffBtn = new FocusButton("res/21dian/exit/music_d.png", "res/21dian/exit/music_d.png", "", ccui.Widget.PLIST_TEXTURE).to(this.panel).pp(0.5, 0.22).hide();
    ...
    initClipper: function () {
        ...
        this.clipper = new cc.ClippingNode().anchor(0, 1).to(this).size(this.panel.cw(), this.panel.ch()).p(0, cc.winSize.height - h);
