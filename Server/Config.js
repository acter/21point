/**
 * Created by orange on 2016/7/27.
 */
...
function ControlConfig() {
    ...
    this.nowStock = 25000000;           //初始库存 2500w
    this.nowTax = 0;                    //当前抽水
    this.taxRate = 0.01;                //抽水比率， 抽水比率应小于 低水位蓄水到正常水位的力度， 这样库存达到低水位时， 才能涨到正常水位
    //---------------------------------------------------------------------------------
    //----------------------------------------------------------------------------------
    ...
    //----------------------------------------------------------------------------------
    this.controlDesc = "本游戏支持基础的库存不为0， 及抽水机制， 支持低水位";             //控制描述, 主要写给管理员看。
...
p.onGetContronlCofig = function () {
    ...
    configArray.push(configItem("nowTax", this.nowTax, "当前抽水总和", "r"));
